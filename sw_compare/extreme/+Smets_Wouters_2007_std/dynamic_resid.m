...
residual(23) = lhs - rhs;
lhs = y(52);
rhs = params(29)*y(12)+params(40)*x(it_, 1);
residual(24) = lhs - rhs;
lhs = y(53);
rhs = params(31)*y(13)+params(41)*x(it_, 2);
residual(25) = lhs - rhs;
lhs = y(54);
rhs = params(32)*y(14)+params(42)*x(it_, 3)+x(it_, 1)*params(40)*params(2);
residual(26) = lhs - rhs;
lhs = y(55);
rhs = params(34)*y(15)+params(43)*x(it_, 4);
residual(27) = lhs - rhs;
lhs = y(56);
rhs = params(35)*y(16)+params(44)*x(it_, 5);
residual(28) = lhs - rhs;
lhs = y(57);
rhs = params(36)*y(17)+y(29)-params(8)*y(2);
residual(29) = lhs - rhs;
lhs = y(29);
rhs = params(45)*x(it_, 6);
residual(30) = lhs - rhs;
lhs = y(58);
rhs = params(37)*y(18)+y(28)-params(7)*y(1);
residual(31) = lhs - rhs;
lhs = y(28);
rhs = params(46)*x(it_, 7);
residual(32) = lhs - rhs;
lhs = y(60);
