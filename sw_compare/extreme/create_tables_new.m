...
results_P(1:3,cs)=targets([3 4 2])';
results_PQ(1:3,cs)=targets([3 4 2])';

load('solab_results');cs=2;  errors_w=errors_solab; actual_w=actual_solab;
results_P(1:3,cs)=actual_w([3 4 2])';
results_P(4:end,cs)=errors_w(P_select,1);
results_PQ(1:3,cs)=actual_w([3 4 2])';
results_PQ(4:end,cs)=errors_w(P_select,5);
results_PQ(7,cs)=results_P(7,cs);
results_Q(1,cs)=actual_w(3);
