...
residual(23) = lhs - rhs;
lhs = y(32);
rhs = y(32)*params(29)+params(40)*x(1);
residual(24) = lhs - rhs;
lhs = y(33);
rhs = y(33)*params(31)+params(41)*x(2);
residual(25) = lhs - rhs;
lhs = y(34);
rhs = y(34)*params(32)+params(42)*x(3)+x(1)*params(40)*params(2);
residual(26) = lhs - rhs;
lhs = y(35);
rhs = y(35)*params(34)+params(43)*x(4);
residual(27) = lhs - rhs;
lhs = y(36);
rhs = y(36)*params(35)+params(44)*x(5);
residual(28) = lhs - rhs;
lhs = y(37);
