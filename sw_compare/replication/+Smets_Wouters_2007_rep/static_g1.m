...
if T_flag
    T = Smets_Wouters_2007_rep.static_g1_tt(T, y, x, params);
end
g1 = zeros(43, 43);
g1(1,11)=(-params(9));
g1(1,18)=(-(1-params(9)));
...
g1(20,32)=(-params(18));
g1(21,20)=(-(T(8)*T(9)));
g1(21,29)=1-T(8)*(params(41)*params(39)+params(21));
g1(21,37)=(-1);
g1(22,25)=(-(T(11)*T(13)));
g1(22,28)=(-(params(23)*T(11)));
g1(22,29)=(-(T(10)+params(19)/(1+params(41)*params(39))-(1+params(41)*params(39)*params(19))/(1+params(41)*params(39))));
...
g1(32,8)=1;
g1(33,26)=(-params(46));
g1(33,35)=(-(params(12)*T(3)*params(46)));
