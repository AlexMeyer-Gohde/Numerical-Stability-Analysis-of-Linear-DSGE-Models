...
clear all
 ...
 dynare Smets_Wouters_2007_rep noclearall;
...
std_L_aim=(oo_aim.var(labobs_index,labobs_index))^(1/2);
std_R_aim=(oo_aim.var(robs_index,robs_index))^(1/2);
std_pi_aim=(oo_aim.var(pinfobs_index,pinfobs_index))^(1/2);
std_Y_aim=(oo_aim.var(dy_index,dy_index))^(1/2);
std_C_aim=(oo_aim.var(dc_index,dc_index))^(1/2);
std_I_aim=(oo_aim.var(dinve_index,dinve_index))^(1/2);
std_w_aim=(oo_aim.var(dw_index,dw_index))^(1/2);

actual_aim=[std_L_aim std_R_aim std_pi_aim std_Y_aim std_C_aim std_I_aim std_w_aim];
...
std_L_solab=(oo_solab.var(labobs_index,labobs_index))^(1/2);
std_R_solab=(oo_solab.var(robs_index,robs_index))^(1/2);
std_pi_solab=(oo_solab.var(pinfobs_index,pinfobs_index))^(1/2);
std_Y_solab=(oo_solab.var(dy_index,dy_index))^(1/2);
std_C_solab=(oo_solab.var(dc_index,dc_index))^(1/2);
std_I_solab=(oo_solab.var(dinve_index,dinve_index))^(1/2);
std_w_solab=(oo_solab.var(dw_index,dw_index))^(1/2);

actual_solab=[std_L_solab std_R_solab std_pi_solab std_Y_solab std_C_solab std_I_solab std_w_solab];
...
std_L_gensys=(oo_gensys.var(labobs_index,labobs_index))^(1/2);
std_R_gensys=(oo_gensys.var(robs_index,robs_index))^(1/2);
std_pi_gensys=(oo_gensys.var(pinfobs_index,pinfobs_index))^(1/2);
std_Y_gensys=(oo_gensys.var(dy_index,dy_index))^(1/2);
std_C_gensys=(oo_gensys.var(dc_index,dc_index))^(1/2);
std_I_gensys=(oo_gensys.var(dinve_index,dinve_index))^(1/2);
std_w_gensys=(oo_gensys.var(dw_index,dw_index))^(1/2);

actual_gensys=[std_L_gensys std_R_gensys std_pi_gensys std_Y_gensys std_C_gensys std_I_gensys std_w_gensys];
...
std_L_uhlig=(oo_uhlig.var(labobs_index,labobs_index))^(1/2);
std_R_uhlig=(oo_uhlig.var(robs_index,robs_index))^(1/2);
std_pi_uhlig=(oo_uhlig.var(pinfobs_index,pinfobs_index))^(1/2);
std_Y_uhlig=(oo_uhlig.var(dy_index,dy_index))^(1/2);
std_C_uhlig=(oo_uhlig.var(dc_index,dc_index))^(1/2);
std_I_uhlig=(oo_uhlig.var(dinve_index,dinve_index))^(1/2);
std_w_uhlig=(oo_uhlig.var(dw_index,dw_index))^(1/2);

actual_uhlig=[std_L_uhlig std_R_uhlig std_pi_uhlig std_Y_uhlig std_C_uhlig std_I_uhlig std_w_uhlig];
...
std_L_bp=(oo_bp.var(labobs_index,labobs_index))^(1/2);
std_R_bp=(oo_bp.var(robs_index,robs_index))^(1/2);
std_pi_bp=(oo_bp.var(pinfobs_index,pinfobs_index))^(1/2);
std_Y_bp=(oo_bp.var(dy_index,dy_index))^(1/2);
std_C_bp=(oo_bp.var(dc_index,dc_index))^(1/2);
std_I_bp=(oo_bp.var(dinve_index,dinve_index))^(1/2);
std_w_bp=(oo_bp.var(dw_index,dw_index))^(1/2);

actual_bp=[std_L_bp std_R_bp std_pi_bp std_Y_bp std_C_bp std_I_bp std_w_bp];
