...
addpath('D:\Cloud\PowerFolder\Newton_Saecker\code\reproduction\newton_matrix_quadratic_0_9_2_QE\algorithm')
clear all
 load('Y')
...
inputs.P=double([X_stable double(Q_exact)*Y(6); 0 0 Y(6)]);
D_d=subs(D,{h beta delta alpha sigma rho omega},{Y(1) Y(2) Y(3) Y(4) Y(5) Y(6) Y(7)});
inputs.D=[0;0;1];
inputs.Q=double([Q_exact; 1]);
%[impact_errors_exact] = matrix_impact_backward_errors_vector(inputs)
[errors_exact] = dsge_backward_errors_condition_full(inputs)
...
inputs.P=[ALPHA_ZS_uhlig BETA_ZS_uhlig*rho; 0 0 rho];
inputs.D=[0;0;1];
inputs.Q=[BETA_ZS_uhlig; 1];
load('matrix_quadratic')
...
newton_options.initial=inputs.P(oo_.dr.order_var,oo_.dr.order_var);
[X,X_additional] = newton_matrix_quadratic(matrix_quadratic,newton_options);
inputs.P=X(oo_.dr.inv_order_var,oo_.dr.inv_order_var);
[errors_uhlig] = dsge_backward_errors_condition_full(inputs)
save('uhlig_results_saecker','rp_uhlig','ALPHA_ZS_uhlig','BETA_ZS_uhlig','log_c_std_uhlig','eig_seperation_uhlig','eigval_uhlig','errors_uhlig')
rmpath('uhlig')
...
inputs.B=[B D;0 0 -1];
inputs.C=[C zeros(2,1);0 0 rho];
inputs.P=[ALPHA_ZS_aim BETA_ZS_aim*rho; 0 0 rho];
inputs.D=[0;0;1];
inputs.Q=[BETA_ZS_aim; 1];
load('matrix_quadratic')
newton_options.sylvester_method="dlyap_stripped";
newton_options.maximum_iterations=100;
newton_options.algorithm='baseline';
...
[X,X_additional] = newton_matrix_quadratic(matrix_quadratic,newton_options);
inputs.P=X(oo_.dr.inv_order_var,oo_.dr.inv_order_var);
[errors_aim] =dsge_backward_errors_condition_full(inputs)
save('aim_results_saecker','rp_aim','ALPHA_ZS_aim','BETA_ZS_aim','log_c_std_aim','eig_seperation_aim','eigval_aim','errors_aim')
...
inputs.B=[B D;0 0 -1];
inputs.C=[C zeros(2,1);0 0 rho];
inputs.P=[ALPHA_ZS_solab BETA_ZS_solab*rho; 0 0 rho];
inputs.D=[0;0;1];
inputs.Q=[BETA_ZS_solab; 1];
load('matrix_quadratic')
newton_options.sylvester_method="dlyap_stripped";
newton_options.maximum_iterations=100;
newton_options.algorithm='baseline';
...
[X,X_additional] = newton_matrix_quadratic(matrix_quadratic,newton_options);
inputs.P=X(oo_.dr.inv_order_var,oo_.dr.inv_order_var);
[errors_solab] = dsge_backward_errors_condition_full(inputs)
 save('solab_results_saecker','rp_solab','ALPHA_ZS_solab','BETA_ZS_solab','log_c_std_solab','eig_seperation_solab','eigval_solab','errors_solab')
...
inputs.B=[B D;0 0 -1];
inputs.C=[C zeros(2,1);0 0 rho];
inputs.P=[ALPHA_ZS_gensys BETA_ZS_gensys*rho; 0 0 rho];
inputs.D=[0;0;1];
inputs.Q=[BETA_ZS_gensys; 1];
load('matrix_quadratic')
newton_options.sylvester_method="dlyap_stripped";
newton_options.maximum_iterations=100;
newton_options.algorithm='baseline';
...
[X,X_additional] = newton_matrix_quadratic(matrix_quadratic,newton_options);
inputs.P=X(oo_.dr.inv_order_var,oo_.dr.inv_order_var);
[errors_gensys] = dsge_backward_errors_condition_full(inputs)
 save('gensys_results_saecker','rp_gensys','ALPHA_ZS_gensys','BETA_ZS_gensys','log_c_std_gensys','eig_seperation_gensys','eigval_gensys','errors_gensys')
rmpath('gensys') 
...
inputs.B=[B D;0 0 -1];
inputs.C=[C zeros(2,1);0 0 rho];
inputs.P=[ALPHA_ZS_bp BETA_ZS_bp*rho; 0 0 rho];
inputs.D=[0;0;1];
inputs.Q=[BETA_ZS_bp; 1];
load('matrix_quadratic')
newton_options.sylvester_method="dlyap_stripped";
newton_options.maximum_iterations=100;
newton_options.algorithm='baseline';
...
[X,X_additional] = newton_matrix_quadratic(matrix_quadratic,newton_options);
inputs.P=X(oo_.dr.inv_order_var,oo_.dr.inv_order_var);
[errors_bp] = dsge_backward_errors_condition_full(inputs)
 save('bp_results_saecker','rp_bp','ALPHA_ZS_bp','BETA_ZS_bp','log_c_std_bp','eig_seperation_bp','eigval_bp', 'errors_bp')
...
inputs.B=[B D;0 0 -1];
inputs.C=[C zeros(2,1);0 0 rho];
inputs.P=[ALPHA_ZS_dynare BETA_ZS_dynare*rho; 0 0 rho];
inputs.D=[0;0;1];
inputs.Q=[BETA_ZS_dynare; 1];
load('matrix_quadratic')
newton_options.sylvester_method="dlyap_stripped";
newton_options.maximum_iterations=100;
newton_options.algorithm='baseline';
...
[X,X_additional] = newton_matrix_quadratic(matrix_quadratic,newton_options);
inputs.P=X(oo_.dr.inv_order_var,oo_.dr.inv_order_var);
[errors_dynare] =dsge_backward_errors_condition_full(inputs)
 save('dynare_results_saecker','rp_dynare','ALPHA_ZS_dynare','BETA_ZS_dynare','log_c_std_dynare','eig_seperation_dynare','eigval_dynare','errors_dynare')
     path(p); 
 clear all
 p = path; 
 load('dynare_location')
...
inputs.B=[B D;0 0 -1];
inputs.C=[C zeros(2,1);0 0 rho];
inputs.P=[ALPHA_ZS_dynare_cr BETA_ZS_dynare_cr*rho; 0 0 rho];
inputs.D=[0;0;1];
inputs.Q=[BETA_ZS_dynare_cr; 1];
load('matrix_quadratic')
newton_options.sylvester_method="dlyap_stripped";
newton_options.maximum_iterations=100;
newton_options.algorithm='baseline';
...
[X,X_additional] = newton_matrix_quadratic(matrix_quadratic,newton_options);
inputs.P=X(oo_.dr.inv_order_var,oo_.dr.inv_order_var);
[errors_dynare_cr] = dsge_backward_errors_condition_full(inputs)
 save('dynare_cr_results_saecker','rp_dynare_cr','ALPHA_ZS_dynare_cr','BETA_ZS_dynare_cr','log_c_std_dynare_cr','eig_seperation_dynare_cr','eigval_dynare_cr','errors_dynare_cr')
