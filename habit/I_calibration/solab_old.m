...
function [n,l,f,p] = solab(a,b,phi,c,nk);
...
if nk<1 %With a "small" number of endogenous variables, direct calculation quicker
...
n=(z22-z21*z11i*z12)*m;
l=-z11*dyn*z12*m+z11*s11\(t12*m-s12*m*phi+q(1:2*nk-nd,:)*c)+z12*m*phi;
