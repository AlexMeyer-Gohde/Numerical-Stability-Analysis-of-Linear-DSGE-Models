...
options_ = [];
M_.fname = 'jermann98_moments_comparison_alt';
...
matrix_quadratic_dynare_cr=NaN(size(matrix_quadratic_dynare));
errors_dynare_cr=NaN(size(errors_dynare));
actual_dynare_cr=NaN(size(actual_dynare));
...
save([M_.dname filesep 'Output' filesep 'jermann98_moments_comparison_alt_results.mat'], 'oo_', 'M_', 'options_');
if exist('estim_params_', 'var') == 1
  save([M_.dname filesep 'Output' filesep 'jermann98_moments_comparison_alt_results.mat'], 'estim_params_', '-append');
end
if exist('bayestopt_', 'var') == 1
  save([M_.dname filesep 'Output' filesep 'jermann98_moments_comparison_alt_results.mat'], 'bayestopt_', '-append');
end
if exist('dataset_', 'var') == 1
  save([M_.dname filesep 'Output' filesep 'jermann98_moments_comparison_alt_results.mat'], 'dataset_', '-append');
end
if exist('estimation_info', 'var') == 1
  save([M_.dname filesep 'Output' filesep 'jermann98_moments_comparison_alt_results.mat'], 'estimation_info', '-append');
end
if exist('dataset_info', 'var') == 1
  save([M_.dname filesep 'Output' filesep 'jermann98_moments_comparison_alt_results.mat'], 'dataset_info', '-append');
end
if exist('oo_recursive_', 'var') == 1
  save([M_.dname filesep 'Output' filesep 'jermann98_moments_comparison_alt_results.mat'], 'oo_recursive_', '-append');
end
if ~isempty(lastwarn)
